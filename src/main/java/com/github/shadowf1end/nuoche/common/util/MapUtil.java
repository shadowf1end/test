...
public class MapUtil {
    ...
    public static double[] randomCorrds(double[] corrds) {
        Random random = new Random();
        double lat = random.nextDouble() * (corrds[2] - corrds[0]) + corrds[0];
        double lng = random.nextDouble() * (corrds[3] - corrds[1]) + corrds[1];
